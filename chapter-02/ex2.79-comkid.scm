...
(run (make-testcase 
      ; ordinary number
      '(assert-true? (equ? (make-scheme-number 2) 
                           (make-scheme-number 2))) 
      '(assert-false? (equ? (make-scheme-number 2) 
                            (make-scheme-number 3))) 
      '(assert-true? (equ? (make-scheme-number 2) 2)) 
      ; rational number
      '(assert-true? (equ? (make-rational 1 2) 
                           (make-rational 2 4))) 
      '(assert-false? (equ? (make-rational 1 3) 
                            (make-rational 2 4))) 
      ; complex number
      '(assert-true? (equ? (make-complex-from-real-imag 1 1) 
                           (make-complex-from-real-imag 1 1))) 
      '(assert-true? (equ? (make-complex-from-mag-ang 1 1) 
                           (make-complex-from-mag-ang 1 1))) 
      '(assert-true? (equ? (make-complex-from-real-imag 1 1) 
                           (make-complex-from-mag-ang (sqrt 2) (/ PI 4))))
      '(assert-false? (equ? (make-complex-from-real-imag 1 2) 
                            (make-complex-from-mag-ang (sqrt 2) (/ PI 4)))) 
      ))
