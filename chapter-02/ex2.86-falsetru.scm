...
(define (make-rat n d) (let ((n (round n)) (d (round d))) (let ((g (gcd n d))) (cons (/ n g) (/ d g)))))
...
(define (install-complex-package)
  ...
  (define (div-complex z1 z2) (make-from-mag-ang (mul (magnitude z1) (magnitude z2)) (sub (angle z1) (angle z2))))
